...
var Movie = function Movie(props) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                "div",
                { className: "col-4 col-md-3 mb-3 pl-5 text-center" },
                React.createElement(
                    "a",
            ...
            React.createElement(
                "div",
                { className: "col-8 col-md-9 mb-3 text-left" },
                React.createElement(
                    "a",
                    { className: "movieList", href: "https://www.imdb.com/title/" + imdbID + "/", target: "_blank" },
                    React.createElement(
                        "h4",
                        null,
                        Title
        ...
        React.createElement("hr", { className: "mb-4 break" })
    );
};
...
var MovieFinder = function (_React$Component) {
    ...
    _createClass(MovieFinder, [{
        ...
        value: function handleSubmit(event) {
            ...
            fetch("http://www.omdbapi.com/?s=" + searchTerm + "&apikey=516b1aec").then(checkStatus).then(json).then(function (data) {
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "div",
                        { className: "my-auto mx-auto border bg-dark rounded" },
                        React.createElement(
                            "h3",
                        ...
                        React.createElement(
                            "form",
                            { onSubmit: this.handleSubmit, className: "form-inline mb-3" },
                            React.createElement(
                                "div",
                                { className: "my-3 mx-auto" },
                                React.createElement("input", { className: "form-control ml-4 pb-1 border rounded bg-light", onChange: this.handleChange, type: "text", value: searchTerm, placeholder: "Movie Title" }),
                                React.createElement(
                                    "button",
                                    { className: "btn btn-sm btn-primary ml-2 mr-4 my-auto py-1", type: "submit", value: "submit" },
                                    "Search"
                                )
                            )
                        ),
